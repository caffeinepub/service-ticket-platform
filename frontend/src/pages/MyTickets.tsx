...
import { PlusCircle, TicketIcon, RefreshCw } from 'lucide-react';
        ...
        <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        {tickets ? `${tickets.length} ticket${tickets.length !== 1 ? 's' : ''} submitted` : 'Loading...'}
                    </p>
                </div>
                <div className="flex gap-2">
                    ...
                    <Button size="sm" onClick={() => onNavigate('raise-ticket')} className="gap-1.5">
            ...
            {!isLoading && !isError && tickets && tickets.length === 0 && (
                <div className="text-center py-16">
                    ...
                    <h3 className="font-semibold text-foreground mb-1 font-display">No tickets yet</h3>
