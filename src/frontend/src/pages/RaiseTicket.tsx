            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setForm((f) => ({ ...f, moduleName: val }))
                  }
                >
                  <SelectTrigger
                    id="moduleName"
                    className={`mt-1 ${errors.moduleName ? "border-destructive" : ""}`}
                  >
              ...
              <div>
                ...
                <Select
                  value={form.priority}
                  onValueChange={(val) =>
                    setForm((f) => ({ ...f, priority: val as TicketPriority }))
                  }
                >
                  <SelectTrigger
                    id="priority"
                    className={`mt-1 ${errors.priority ? "border-destructive" : ""}`}
                  >
